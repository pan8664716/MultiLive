...
from multilive.config import load_sources
...
def main(argv=None):
    ...
    keep_stale = {name: platforms[name].keep_stale for name in sources}
    fallback_fn = platforms['douyin'].fallback_url if 'douyin' in platforms else None
